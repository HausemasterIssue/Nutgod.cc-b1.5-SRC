...
public final class GeometryMasks {
    ...
    static {
        GeometryMasks.FACEMAP.put(EnumFacing.DOWN, Integer.valueOf(1));
        GeometryMasks.FACEMAP.put(EnumFacing.WEST, Integer.valueOf(16));
        GeometryMasks.FACEMAP.put(EnumFacing.NORTH, Integer.valueOf(4));
        GeometryMasks.FACEMAP.put(EnumFacing.SOUTH, Integer.valueOf(8));
        GeometryMasks.FACEMAP.put(EnumFacing.EAST, Integer.valueOf(32));
        GeometryMasks.FACEMAP.put(EnumFacing.UP, Integer.valueOf(2));
    }
