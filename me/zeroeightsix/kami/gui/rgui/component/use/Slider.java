...
public class Slider extends AbstractComponent {
    ...
    private double calculateValue(double x) {
        ...
        return MathHelper.clamp(Math.floor((double) Math.round(s / this.step) * this.step * 100.0D) / 100.0D, this.minimum, this.maximum);
    }
    ...
    public abstract static class SliderPoof extends Poof {
